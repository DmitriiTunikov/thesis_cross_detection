...
{\noindent\MakeUppercase{Преобразование Хафа, Машина опорных векторов, Гистограмма ориентированных градиентов}} % Ключевые слова из renames.tex
...
{\noindent\MakeUppercase{Hough transform, Support Vector Machine, Histogram of oriented gradients}} % Ключевые слова из renames.tex 

...
\justify
{\noindent\MakeUppercase{ключевые слова: преобразование хафа, машина опорных векторов, гистограмма ориентированных градиентов, поиск объектов на изображении, обнаружение железнодорожных стрелок}} % Ключевые слова из renames.tex
...
{\noindent\MakeUppercase{keywords: hough transform, support vector machine, histogram of oriented gradients, object detection, detection of railway switches}} % Ключевые слова из renames.tex 
